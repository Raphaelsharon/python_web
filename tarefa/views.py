...
import jwt
from tarefa.models import TarefaModels
...
class TarefaView(APIView):
    ...
    permission_calsses = [ValidToken, IsNotSuspended]
    queryset = TarefaModels.objects.all() 
    ...
    def get_object(self, pk, user):
        ...
        except TarefaModels.DoesNotExist:
    ...
    def get(self,request, id = None):
        ...
        if id is not None:
            ...
            tarefa = self.queryset.filter(nome = name, delete = False, user = user)
    ...
    def delete(self, request, id):
        ...
        return Response({"manssage":"Algo deu errado ao deletar!!"}, status= 400)
